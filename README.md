...
docs/
  ...
  4.presentation/ 발표 공통 지침(4-0)·핸드오프(4-1)·주차별 구성안(4-2, 4-3)과 덱 생성 소스 — 발표 준비 시에만 갱신
  제안요청서 원본.pdf
```
...
| # | 문서 | 내용 |
|---|---|---|
| 4-0 | [발표자료 공통 지침](docs/4.presentation/4-0_발표자료_공통지침.md) | 주간 진행상황 발표를 만드는 순서·내용 원칙·슬라이드 디자인 규칙·캡처 규칙·폴더 구조 — 발표자료 작성 시 먼저 읽을 것 |
