...
- [ ] **Phase 4 — 게시판 + 혼잡도관리**: 계층형 게시판, 혼잡도 자동계산 ([1-5](docs/1.spec/30_운영지원/1-5_게시판_공지사항.md), [1-9](docs/1.spec/30_운영지원/1-9_혼잡도관리.md)) — 게시판은 API+화면 모두 완료(2026-09-18, 첨부파일·상단고정·교육 실시 기록만 미구현). **혼잡도관리는 조회 API만 있고 자동계산·수동보정 전부 미착수라 데모 기준 미완료**
